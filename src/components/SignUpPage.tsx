...
const SignUpPageMain = ({ navigation }) => {
      ...
      createUserWithEmailAndPassword(auth, userName, password)
        .then((userCredential) => {
          ...
          try {
            ...
            Alert.alert("User Created", "user created sucessfully!", [
              {
                text: "Ok",
...
const SignUpPage = () => {
  return (
    ...
    >
      <Stack.Screen name="SignUpNow" component={SignUpPageMain} />
      <Stack.Screen
        name="LoginNow"
        component={LoginPage}
        options={{ title: "Login into app" }}
      />
    </Stack.Navigator>
  );
};
